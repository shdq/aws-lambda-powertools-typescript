...
import { LogFormatterInterface, PowertoolLogFormatter } from './formatter/index.js';
import { LogItem } from './log/index.js';
import merge from 'lodash.merge';
import { ConfigServiceInterface, EnvironmentVariablesService } from './config/index.js';
